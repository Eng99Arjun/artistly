    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-gray-100">Artistly</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/artists" className="text-gray-400 hover:text-white">Artists</a></li>
              <li><a href="/onboard" className="text-gray-400 hover:text-white">Onboard Artist</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/events" className="text-gray-400 hover:text-white">Event Ideas</a></li>
