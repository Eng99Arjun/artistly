...
export default function Dashboard() {
  ...
  const submissions = [
    { id: 1, name: 'John Doe', category: 'Singer', location: 'New York', feeRange: '$501-1000', status: 'Pending', date: '2023-06-15' },
    { id: 2, name: 'Dance Fusion', category: 'Dancers', location: 'Los Angeles', feeRange: '$1001-2500', status: 'Approved', date: '2023-06-10' },
    { id: 3, name: 'Tech Talkers', category: 'Speakers', location: 'San Francisco', feeRange: '$2500+', status: 'Rejected', date: '2023-06-05' },
    { id: 4, name: 'Melody Makers', category: 'Band', location: 'Chicago', feeRange: '$5001-10000', status: 'Pending', date: '2023-06-01' },
  ];
